...
type Config struct {
	...
	RequestBudgetRedisURL    string `env:"REQUEST_BUDGET_REDIS_URL"`
	RequestBudgetRedisPrefix string `env:"REQUEST_BUDGET_REDIS_PREFIX" envDefault:"infinite-canvas:request-budget"`
